  ...
  const features = [
    {
      ...
      description: "Integrado con n8n e IA para conversaciones naturales. Atiende a tus clientes 24/7 con respuestas inteligentes y personalizadas.",
      gradient: "from-green-500/20 to-emerald-500/10"
    },
    {
      icon: Calendar,
      title: "Calendario Inteligente",
      description: "Sincronización en tiempo real con Google Calendar. Gestiona disponibilidad automáticamente y evita doble reservas.",
      gradient: "from-blue-500/20 to-cyan-500/10"
    },
    {
      icon: Bell,
      title: "Recordatorios Automáticos",
      description: "Notificaciones por SMS y WhatsApp para reducir no-shows. Configura tiempos y mensajes personalizados.",
